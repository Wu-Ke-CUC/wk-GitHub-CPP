	...
	public:
		...
		bool isPalindrome(int x) 
		{
			...
			while (temp)
			{
				...
				temp /= 10;
				ret = ret * 10 + digit;
				if (ret > INT_MAX / 10) return false;
			}
		...
		#pragma endregion
		#pragma region 44.��Ŀͬ10
		#pragma endregion
		#pragma region 45.��Ծ��Ϸ2
		...
		string minWindow(string s, string t) {
			unordered_map<char, int> need, window;  // need��¼t���ַ�����window��¼�������ַ����ִ���
			for (char c : t) need[c]++;              // ͳ��t��ÿ���ַ��ĸ���
			int left = 0, right = 0;                 // ������������ָ��
			int valid = 0;                            // ��¼�����������������ַ����ִ�����꣩���ַ�������
			int start = 0, len = INT_MAX;             // ��¼��С�Ӵ�����ʼλ�úͳ���
			while (right < s.size()) {
				char c = s[right];                     // �������봰�ڵ��ַ�
				right++;                                // ���󴰿�
				if (need.count(c)) {                    // �����ǰ�ַ���t����Ҫ��
					window[c]++;                         // �����ڸ��ַ�������1
					if (window[c] == need[c]) {          // �����ַ����ִ����ﵽ����ʱ
						valid++;                           // ������ַ������1
					}
				}
				// �������Ѱ���t�������ַ�����valid����need�в�ͬ�ַ��ĸ�����ʱ��������������
				while (valid == need.size()) {
					...
					char d = s[left];                     // �����Ƴ����ڵ��ַ�
					left++;                                // ��С����
					if (need.count(d)) {                    // ����Ƴ����ַ���t����Ҫ��
						if (window[d] == need[d]) {          // �Ƴ�ǰ���ַ��պ���������
							valid--;                           // ������ַ��������
						}
						window[d]--;                           // �����ڸ��ַ�������1
					}
